...
const CARDS = (s) => [
  ...
  { href: "/agents", star: true, ic: "🤖", title: "Concierge Agents", badge: "live", bc: "edit",
    desc: "Triage, family updates, document checklists, billing reconciliation — click Run for real model output through the same safety gate as everything else. Not a transcript.",
    stat: `4 agents · safety-gated · works with or without an API key` },
