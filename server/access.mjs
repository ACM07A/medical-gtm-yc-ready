...
const APP_PAGE = /^\/(app|demo|concierge|cases|hospital|agent|vendors?|service-requests|tasks|integrations|readiness|audit|agents|workflows|docs)(\/|$)/;
const APP_API = /^\/api\/(cases|agent-runs|audit|integrations|approvals|tasks|vendors|service-requests|concierge|metrics)(\/|$)/;
