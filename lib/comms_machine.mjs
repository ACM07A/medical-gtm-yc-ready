...
// SCOPE (build-os/09): MedYatra does LIGHT coordination only — demand-gen, qualification, relaying reports to
...
// are partner- (and, with a tenant, operator-) provided — never heavy MedYatra logistics.
export const STAGES = {
  ...
  booking:           { template: "booking",          msgType: "auto", waits: true, cadenceH: [48, 120], cap: 3, onConfirm: "visa", onReschedule: "booking", onStall: "product_selection", onSilent: "dormant", desc: "Patient confirms the hospital slot they want held (MedYatra relays; hospital owns the calendar)" },
  ...
  complication:      { template: "complication",      msgType: "auto", handoff: "hospital", clinical: true, onResolved: "post_op", desc: "Clinical escalation — hospital-led; MedYatra keeps the family informed only" },
