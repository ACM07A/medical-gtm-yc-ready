...
export function routePayment({ method, countryCode, packageEstimateLow = null, insurer = null, hasGOP = false, ourPartnerHospital = null }) {
  ...
  if (method === "self_pay") {
    return { path: "self_pay", nextStep: "Deposit instructions go out once the hospital confirms the estimate. Full payment is made directly to the hospital — Canopus Care never holds patient funds.",
