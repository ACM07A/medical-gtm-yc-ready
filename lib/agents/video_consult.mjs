...
//
// The compliance line (the whole design): the call is PATIENT ↔ DOCTOR. MedYatra schedules it, checks the
...
export function scheduleVideoConsult(db, { leadId, preferredDateTimeIST, language = "en", logRun } = {}) {
  ...
  return {
    ...
    dataScope: "scheduling metadata only — MedYatra does not join, record, or store the clinical conversation",
  };
}
