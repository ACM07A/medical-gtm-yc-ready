...
// Render an HTML string to a PNG (for on-brand infographics with REAL text — no AI, no gibberish).
export async function shotHtml(html, outPath, { width = 1080, height = 1080 } = {}) {
